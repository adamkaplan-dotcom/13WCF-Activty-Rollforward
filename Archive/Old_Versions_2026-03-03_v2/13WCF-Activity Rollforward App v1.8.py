...
def process_files(weekly_file_path, rollforward_file_path, bth_file_path=None):
    ...
    try:
        ...
        log.append("Loading workbook (this may take a moment for large files)...")
        wb_target = openpyxl.load_workbook(rollforward_file_path)

        # Also load once with data_only=True for reading calculated values (used later)
        log.append("Loading calculated values...")
        wb_target_data = openpyxl.load_workbook(rollforward_file_path, data_only=True)
