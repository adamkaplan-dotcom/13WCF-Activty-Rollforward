...
python3 13WCF-Activity Rollforward App v1.2.py
```
...
```
BalanceUpdater/
├── 13WCF-Activity Rollforward App v1.2.py  # Main Flask application
...
Located in `13WCF-Activity Rollforward App v1.2.py`, lines ~25-223:
...
### Upload Constraints
- Max file size: 100MB (configurable in `13WCF-Activity Rollforward App v1.2.py` line 16)
...
Located in `13WCF-Activity Rollforward App v1.2.py`:
...
All hardcoded references are in `process_files()` function (13WCF-Activity Rollforward App v1.2.py):
...
### Flask Debug Mode
Debug mode is enabled by default (13WCF-Activity Rollforward App v1.2.py line ~316):
```python
...
### Current Version
**v1.2** - `13WCF-Activity Rollforward App v1.2.py`
...
3. **Archive old version:**
   ```bash
   mv "13WCF-Activity Rollforward App v1.2.py" "Archive/Old_Versions_YYYY-MM-DD/"
   ```
4. **Save new version:**
   ```bash
   # Save as: 13WCF-Activity Rollforward App v1.2.py
   ```
5. **Update references:**
...
**Examples:**
- `13WCF-Activity Rollforward App v1.2.py` - Initial release
- `13WCF-Activity Rollforward App v1.2.py` - Bug fixes
